    ...
    if (isset($_POST['login'])) {
        ...
        if (empty($_POST["user_name"])) {
            ...
            if ($nameErr != "" || $passErr != "") {
                ...
                $rsql = "SELECT * FROM admin WHERE  username='{$cusername}' AND password='{$hashed_password}'";
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" type="text" name="user_name" placeholder="Enter UserName" />
                                        </div>
                                        <div class="form-group">
